...
import com.zenapp.papertrading.services.EmailSenderService;
...
public class RegistrationRestController {
    ...
    public ResponseEntity<String> registerUser(@RequestBody String body){
        ...
        try {
            ...
            senderService.sendEmail(obj.getString("email"),"Account created","Your account has been created. Let's start your investment journey!" );
